...
extension String
{
    ...
    func hmac(algorithm: CryptoAlgorithm, key: String) -> String {
        ...
        let result = UnsafeMutablePointer<CUnsignedChar>.allocate(capacity: digestLen)
        let keyStr = key.cString(using: String.Encoding(rawValue: String.Encoding.utf8.rawValue))
        let keyLen = Int(key.lengthOfBytes(using: String.Encoding(rawValue: String.Encoding.utf8.rawValue)))
